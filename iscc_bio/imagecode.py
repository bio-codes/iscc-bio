"""Imagecode generation — ISCC-SUM combined with ISCC-IMAGE and ISCC-MIXED codes.

Generates comprehensive bioimage fingerprints by:
1. Generating ISCC-SUM hash over normalized pixel content during incremental processing
2. Extracting ~5 representative views per scene during the same pass
3. Generating ISCC-IMAGE codes for each view
4. Combining view codes into a global ISCC-MIXED descriptor
"""
